...
# python {"D:\python\conda\envs\brandon\Lib\site-packages\kernprof.py"}   D:\python\nanogram\ppnano\backtrackSuper\src\main.py
...
filename_list = [
    ...
    (
        r'backtrackSuper'
        r'\question\q_lion.txt'
    ),
    (
        r'backtrackSuper\question\q_tv.txt'
    ),
    (
        r'backtrackSuper\question\q_smile.txt'
    ),
    (
        r'backtrackSuper\question\q_s.txt'
    ),
    # (
    #     r'backtrackSuper'
    #     r'\question\q_panda.txt'
    # ),
    # (
    #     r'backtrackSuper'
